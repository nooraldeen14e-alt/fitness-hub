...
const OurClients = () => {
  ...
  const clients: ClientEntry[] = [
    ...
    { name: "Samana Dev.",    logoUrl: local("samana-user.png") },
    ...
    { name: "LinkinCard",     logoUrl: local("linkincard-user.png") },
    { name: "Mazzika",        logoUrl: local("mazzika.png") },

    // ── Uploaded logos — local UAE brands ────────────────────────
    { name: "Casa Milano",    logoUrl: local("casa-milano.png") },
    { name: "VIP & Protocol", logoUrl: local("vip-and-protocol.png") },
    { name: "ELE",            logoUrl: local("ele.png") },
    { name: "Rashed",         logoUrl: local("rashed.png") },
    { name: "SAVVA",          logoUrl: local("savya-luxury-lounge.png") },
    { name: "X-Space RE",     logoUrl: local("x-space-real-estate.png") },
    { name: "Fashion Factor", logoUrl: local("fashion-factor.png") },
    { name: "Sharjah Golf",   logoUrl: local("sharjah-golf-and-shooting-club.png") },
    { name: "Casa Di Spicca", logoUrl: local("casa-di-spicca.png") },
    { name: "Op. Level Up",   logoUrl: local("level-up.png") },
    { name: "MASH Coffee",    logoUrl: local("mash.png") },
    { name: "Twisted Olive",  logoUrl: local("twisted-olive.png") },
    { name: "Fouziana",       logoUrl: local("fouziana.png") },
    // 3 logos from the sheet whose brand name isn't readable — please identify these
    { name: "unknown-1",      logoUrl: local("unknown-red-oval.png") },
    { name: "unknown-2",      logoUrl: local("unknown-j.png") },
    { name: "unknown-3",      logoUrl: local("unknown-w.png") },
    // ── Still placeholder (no logo provided yet) ──────────────────
    { name: "MERAA" },
    { name: "URBERR" },
    { name: "Power Horse" },
    { name: "Al Ain Farms" },
