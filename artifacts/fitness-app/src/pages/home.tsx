...
const ClientsTicker = () => {
  ...
  const clients: LogoPillEntry[] = [
    ...
    { name: "NHS",                    logoUrl: local("nhs.png") },
    { name: "Daym",                   logoUrl: local("daym.png") },
    { name: "Blends Collection",      logoUrl: local("blends-collection.png") },
  ];
...
const WORK_ITEMS = [
  ...
  { video: "real-estate-reel-5.mp4",   category: "Real Estate",           client: "Real Estate",           size: "large" },
];
...
const Footer = () => {
  return (
    <footer id="footer" className="bg-black pt-32 pb-12 px-6">
      <div className="max-w-7xl mx-auto">
        <Contact />
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-6 border-t border-white/10 pt-12 mt-16">
